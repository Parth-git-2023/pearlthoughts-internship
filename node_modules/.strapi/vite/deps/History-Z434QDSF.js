...
var PaginationButton = ({ page, children }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Link2, { to: { search: (0, import_qs2.stringify)({ ...queryRest, page }) }, style: { textDecoration: "none" }, children: (0, import_jsx_runtime4.jsx)(Typography, { variant: "omega", textColor: "primary600", children }) });
};
var VersionsList = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=History-Z434QDSF.js.map
