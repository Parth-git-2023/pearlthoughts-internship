...
function b(e2) {
  ...
  if ("object" == typeof process && true && !t2) throw new Error("useContextUpdate requires special context");
  const { u: n2 } = t2;
  return n2;
}
var x = ({ context: e2, value: r2, children: t2 }) => {
  const { [f]: o2 } = e2;
  if ("object" == typeof process && true && !o2) throw new Error("BridgeProvider requires special context");
  return (0, import_react.createElement)(o2, { value: r2 }, t2);
};
var j = (e2) => {
  const t2 = (0, import_react.useContext)(e2);
  if ("object" == typeof process && true && !t2[d]) throw new Error("useBridgeValue requires special context");
  return t2;
};
...
scheduler/cjs/scheduler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZCDXR5JO.js.map
