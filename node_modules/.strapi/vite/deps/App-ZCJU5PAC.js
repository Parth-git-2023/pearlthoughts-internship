import {
  ...
  utcToZonedTime,
  zonedTimeToUtc
} from "./chunk-CMJBG34E.js";
import {
  PERMISSIONS,
  ReleaseActionMenu,
  ReleaseActionOptions,
  pluginId
} from "./chunk-2ZPJA6H4.js";
  ...
  if (action === "publish") {
    if (hasErrors || requiredStage && requiredStage.id !== (entryStage == null ? void 0 : entryStage.id)) {
      return (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(
        ...
        {
          variant: "ghost",
          startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4b, { fill: "danger600" }),
    ...
    if (status === "draft") {
      return (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(
        ...
        {
          variant: "ghost",
          startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4L, { fill: "success600" }),
          endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4$, {}),
    ...
    if (status === "modified") {
      return (0, import_jsx_runtime.jsx)(Popover.Trigger, { children: (0, import_jsx_runtime.jsx)(
        ...
        {
          variant: "ghost",
          startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$5h, { fill: "alternative600" }),
          endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4$, {}),
...
var ReleaseModal = ({
  ...
  return (0, import_jsx_runtime3.jsx)(Modal.Root, { open, onOpenChange: handleClose, children: (0, import_jsx_runtime3.jsxs)(Modal.Content, { children: [
    ...
    (0, import_jsx_runtime3.jsx)(
      Formik,
      {
        ...
        children: ({ values, errors, handleChange, setFieldValue }) => {
          return (0, import_jsx_runtime3.jsxs)(Form, { children: [
            (0, import_jsx_runtime3.jsx)(Modal.Body, { children: (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
              (0, import_jsx_runtime3.jsxs)(
                Field.Root,
                {
                  ...
                  children: [
                    ...
                    (0, import_jsx_runtime3.jsx)(TextInput, { value: values.name, onChange: handleChange }),
                    (0, import_jsx_runtime3.jsx)(Field.Error, {})
                  ]
                }
              ),
              (0, import_jsx_runtime3.jsx)(Box, { width: "max-content", children: (0, import_jsx_runtime3.jsx)(
                CheckboxImpl,
                {
                  name: "isScheduled",
              ...
              values.isScheduled && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
                (0, import_jsx_runtime3.jsxs)(Flex, { gap: 4, alignItems: "start", children: [
                  (0, import_jsx_runtime3.jsx)(Box, { width: "100%", children: (0, import_jsx_runtime3.jsxs)(
                    Field.Root,
                    {
                      name: "date",
                ...
                (0, import_jsx_runtime3.jsx)(TimezoneComponent, { timezoneOptions: timezoneList })
              ] })
            ] }) }),
            (0, import_jsx_runtime3.jsxs)(Modal.Footer, { children: [
              ...
              (0, import_jsx_runtime3.jsx)(Button, { name: "submit", loading: isLoading, type: "submit", children: formatMessage(
                {
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(
          Combobox,
          {
            ...
            children: timezoneList.map((timezone) => (0, import_jsx_runtime3.jsx)(Option, { value: timezone.value, children: timezone.value.replace(/&/, " ") }, timezone.value))
          }
        ),
        (0, import_jsx_runtime3.jsx)(Field.Error, {})
      ]
  ...
  if ((releases == null ? void 0 : releases.length) === 0) {
    return (0, import_jsx_runtime4.jsx)(
      EmptyStateLayout,
      {
        ...
        icon: (0, import_jsx_runtime4.jsx)(ForwardRef$J, { width: "16rem" })
      }
    );
  }
  return (0, import_jsx_runtime4.jsx)(Grid.Root, { gap: 4, children: releases.map(({ id, name, scheduledAt, status }) => (0, import_jsx_runtime4.jsx)(Grid.Item, { col: 3, s: 6, xs: 12, direction: "column", alignItems: "stretch", children: (0, import_jsx_runtime4.jsx)(LinkCard, { tag: NavLink, to: `${id}`, isExternal: false, children: (0, import_jsx_runtime4.jsxs)(
    Flex,
    {
      direction: "column",
      ...
      gap: 4,
      children: [
        (0, import_jsx_runtime4.jsxs)(Flex, { direction: "column", alignItems: "start", gap: 1, children: [
          (0, import_jsx_runtime4.jsx)(Typography, { textColor: "neutral800", tag: "h3", variant: "delta", fontWeight: "bold", children: name }),
          (0, import_jsx_runtime4.jsx)(Typography, { variant: "pi", textColor: "neutral600", children: scheduledAt ? (0, import_jsx_runtime4.jsx)(RelativeTime2, { timestamp: new Date(scheduledAt) }) : formatMessage({
            id: "content-releases.pages.Releases.not-scheduled",
            defaultMessage: "Not scheduled"
          }) })
        ] }),
        (0, import_jsx_runtime4.jsx)(Badge, { ...getBadgeProps(status), children: status })
      ]
    }
  ) }) }, id)) });
};
...
var ReleasesPage = () => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Main, { "aria-busy": isLoadingReleases || isLoadingSettings, children: [
    (0, import_jsx_runtime4.jsx)(
      Layouts.Header,
      {
        ...
        secondaryAction: (0, import_jsx_runtime4.jsx)(
          GradientBadgeWithIcon,
          {
            label: formatMessage({
        ...
        primaryAction: canCreate ? (0, import_jsx_runtime4.jsx)(
          Button,
          {
    ...
    (0, import_jsx_runtime4.jsx)(Layouts.Content, { children: (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      hasReachedMaximumPendingReleases && (0, import_jsx_runtime4.jsx)(
        StyledAlert,
        {
          marginBottom: 6,
          action: (0, import_jsx_runtime4.jsx)(Link, { href: "https://strapi.io/pricing-cloud", isExternal: true, children: formatMessage({
      ...
      (0, import_jsx_runtime4.jsxs)(Tabs.Root, { variant: "simple", onValueChange: handleTabChange, value: activeTab, children: [
        (0, import_jsx_runtime4.jsxs)(Box, { paddingBottom: 8, children: [
          (0, import_jsx_runtime4.jsxs)(
            Tabs.List,
            {
              ...
              children: [
                (0, import_jsx_runtime4.jsx)(Tabs.Trigger, { value: "pending", children: formatMessage(
                  {
                ...
                (0, import_jsx_runtime4.jsx)(Tabs.Trigger, { value: "done", children: formatMessage({
        ...
        (0, import_jsx_runtime4.jsx)(Tabs.Content, { value: "pending", children: (0, import_jsx_runtime4.jsx)(
          ReleasesGrid,
          {
        ...
        (0, import_jsx_runtime4.jsx)(Tabs.Content, { value: "done", children: (0, import_jsx_runtime4.jsx)(
          ReleasesGrid,
          {
            sectionTitle: "done",
      ...
      (0, import_jsx_runtime4.jsxs)(
        Pagination.Root,
        {
          ...
          children: [
            (0, import_jsx_runtime4.jsx)(Pagination.PageSize, { options: ["8", "16", "32", "64"] }),
...
var ReleaseDetailsLayout = ({
  ...
  return (0, import_jsx_runtime5.jsxs)(Main, { "aria-busy": isLoadingDetails, children: [
    (0, import_jsx_runtime5.jsx)(
      Layouts.Header,
      {
        title: release.name,
        subtitle: (0, import_jsx_runtime5.jsxs)(Flex, { gap: 2, lineHeight: 6, children: [
          (0, import_jsx_runtime5.jsx)(Typography, { textColor: "neutral600", variant: "epsilon", children: numberOfEntriesText + (isScheduled ? ` - ${scheduledText}` : "") }),
          (0, import_jsx_runtime5.jsx)(Badge, { ...getBadgeProps(release.status), children: release.status })
        ] }),
        navigationAction: (0, import_jsx_runtime5.jsx)(BackButton, { fallback: ".." }),
        primaryAction: !release.releasedAt && (0, import_jsx_runtime5.jsxs)(Flex, { gap: 2, children: [
              ...
              children: [
                ...
                (0, import_jsx_runtime5.jsxs)(
                  ReleaseInfoWrapper,
                  {
                    ...
                    padding: 4,
                    children: [
                      (0, import_jsx_runtime5.jsx)(Typography, { variant: "pi", fontWeight: "bold", children: formatMessage({
                        id: "content-releases.header.actions.created",
                        defaultMessage: "Created"
                      }) }),
                      (0, import_jsx_runtime5.jsxs)(Typography, { variant: "pi", color: "neutral300", children: [
                        (0, import_jsx_runtime5.jsx)(RelativeTime, { timestamp: new Date(release.createdAt) }),
                        formatMessage(
                          {
          ...
          (0, import_jsx_runtime5.jsx)(Button, { size: "S", variant: "tertiary", onClick: handleRefresh, children: formatMessage({
            id: "content-releases.header.actions.refresh",
            defaultMessage: "Refresh"
          }) }),
          canPublish ? (0, import_jsx_runtime5.jsx)(
            Button,
            {
              size: "S",
              variant: "default",
...
var ReleaseDetailsBody = ({ releaseId }) => {
  ...
  if (Object.keys(releaseActions).length === 0) {
    return (0, import_jsx_runtime5.jsx)(Layouts.Content, { children: (0, import_jsx_runtime5.jsx)(
      EmptyStateLayout,
      {
        ...
        icon: (0, import_jsx_runtime5.jsx)(ForwardRef$J, { width: "16rem" }),
        content: formatMessage({
  ...
  return (0, import_jsx_runtime5.jsx)(Layouts.Content, { children: (0, import_jsx_runtime5.jsxs)(Flex, { gap: 8, direction: "column", alignItems: "stretch", children: [
    (0, import_jsx_runtime5.jsx)(Flex, { children: (0, import_jsx_runtime5.jsx)(
      SingleSelect,
      {
        ...
        children: options.map((option) => (0, import_jsx_runtime5.jsx)(SingleSelectOption, { value: option, children: formatMessage(getGroupByOptionLabel(option)) }, option))
      }
    ) }),
    Object.keys(releaseActions).map((key) => (0, import_jsx_runtime5.jsxs)(Flex, { gap: 4, direction: "column", alignItems: "stretch", children: [
      (0, import_jsx_runtime5.jsx)(Flex, { role: "separator", "aria-label": key, children: (0, import_jsx_runtime5.jsx)(Badge, { children: key }) }),
      (0, import_jsx_runtime5.jsx)(
        Table.Root,
        {
          ...
          children: (0, import_jsx_runtime5.jsxs)(Table.Content, { children: [
            (0, import_jsx_runtime5.jsx)(Table.Head, { children: headers.map(({ label, name }) => (0, import_jsx_runtime5.jsx)(Table.HeaderCell, { label: formatMessage(label), name }, name)) }),
            (0, import_jsx_runtime5.jsx)(Table.Loading, {}),
            (0, import_jsx_runtime5.jsx)(Table.Body, { children: releaseActions[key].map(
              ({ id, contentType, locale, type, entry, status }, actionIndex) => (0, import_jsx_runtime5.jsxs)(Tr, { children: [
                (0, import_jsx_runtime5.jsx)(Td, { width: "25%", maxWidth: "200px", children: (0, import_jsx_runtime5.jsx)(Typography, { ellipsis: true, children: `${contentType.mainFieldValue || entry.id}` }) }),
                hasI18nEnabled && (0, import_jsx_runtime5.jsx)(Td, { width: "10%", children: (0, import_jsx_runtime5.jsx)(Typography, { children: `${(locale == null ? void 0 : locale.name) ? locale.name : "-"}` }) }),
                (0, import_jsx_runtime5.jsx)(Td, { width: "10%", children: (0, import_jsx_runtime5.jsx)(Typography, { children: contentType.displayName || "" }) }),
                (0, import_jsx_runtime5.jsx)(Td, { width: "20%", children: release.releasedAt ? (0, import_jsx_runtime5.jsx)(Typography, { children: formatMessage(
                  {
                  ...
                  },
                  {
                    ...
                    b: (children) => (0, import_jsx_runtime5.jsx)(Typography, { fontWeight: "bold", children })
                  }
                ) }) : (0, import_jsx_runtime5.jsx)(
                  ReleaseActionOptions,
                  {
                ...
                !release.releasedAt && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
                  (0, import_jsx_runtime5.jsx)(Td, { width: "20%", minWidth: "200px", children: (0, import_jsx_runtime5.jsx)(
                  ...
                  (0, import_jsx_runtime5.jsx)(Td, { children: (0, import_jsx_runtime5.jsx)(Flex, { justifyContent: "flex-end", children: (0, import_jsx_runtime5.jsxs)(ReleaseActionMenu.Root, { children: [
                    (0, import_jsx_runtime5.jsx)(
...
var ReleaseDetailsPage = () => {
  ...
  if (!releaseId) {
    return (0, import_jsx_runtime5.jsx)(Navigate, { to: ".." });
  }
  ...
  return (0, import_jsx_runtime5.jsxs)(
    ReleaseDetailsLayout,
    {
      ...
      toggleWarningSubmit,
      children: [
        (0, import_jsx_runtime5.jsx)(ReleaseDetailsBody, { releaseId }),
        (0, import_jsx_runtime5.jsx)(
          ReleaseModal,
          {
            open: releaseModalShown,
        ...
        (0, import_jsx_runtime5.jsx)(Dialog.Root, { open: showWarningSubmit, onOpenChange: toggleWarningSubmit, children: (0, import_jsx_runtime5.jsx)(ConfirmDialog, { onConfirm: handleDeleteRelease, children: formatMessage({
...
var App = () => {
  return (0, import_jsx_runtime6.jsx)(Page.Protect, { permissions: PERMISSIONS.main, children: (0, import_jsx_runtime6.jsxs)(Routes, { children: [
    (0, import_jsx_runtime6.jsx)(Route, { index: true, element: (0, import_jsx_runtime6.jsx)(ReleasesPage, {}) }),
    (0, import_jsx_runtime6.jsx)(Route, { path: ":releaseId", element: (0, import_jsx_runtime6.jsx)(ReleaseDetailsPage, {}) })
  ] }) });
};
export {
  App
};
//# sourceMappingURL=App-ZCJU5PAC.js.map
