...
var Number = ({ children, state, ...props }) => {
  return state === STATES.IS_DONE || state === STATES.IS_ACTIVE ? (0, import_jsx_runtime.jsx)(
    Flex,
    {
      ...
      ...props,
      children: state === STATES.IS_DONE ? (0, import_jsx_runtime.jsx)(ForwardRef$4N, { "aria-hidden": true, width: `1.6rem`, fill: "neutral0" }) : (0, import_jsx_runtime.jsx)(Typography, { fontWeight: "semiBold", textColor: "neutral0", children })
    }
...
//# sourceMappingURL=chunk-WYEN65MT.js.map
