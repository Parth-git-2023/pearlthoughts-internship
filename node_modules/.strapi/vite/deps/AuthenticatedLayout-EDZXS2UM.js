  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsxs)(Flex, { alignItems: "stretch", children: [
      ...
      (0, import_jsx_runtime.jsxs)(Box, { children: [
        ...
        ) : (0, import_jsx_runtime.jsx)(Button, { endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$5l, {}), onClick: onCtaClick, children: formatMessage(cta.title) }))
      ] })
    ] }),
...
`;
var MainNav = (props) => (0, import_jsx_runtime2.jsx)(
  MainNavWrapper,
  {
    alignItems: "normal",
    tag: "nav",
...
var NavBrand = () => {
  ...
  return (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsxs)(BrandIconWrapper, { direction: "column", justifyContent: "center", width: "3.2rem", height: "3.2rem", children: [
    ...
    (0, import_jsx_runtime3.jsxs)(VisuallyHidden, { children: [
      (0, import_jsx_runtime3.jsx)("span", { children: formatMessage({
...
var LinkImpl = ({ children, ...props }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(GuidedTourTooltip, { children: (0, import_jsx_runtime4.jsx)(MainNavLinkWrapper, { ...props, children }) });
};
var TooltipImpl2 = ({ children, label, position = "right" }) => {
  return (0, import_jsx_runtime4.jsx)(TooltipImpl, { side: position, label, delayDuration: 0, children: (0, import_jsx_runtime4.jsx)("span", { children }) });
};
var IconImpl = ({ label, children }) => {
  if (!children) {
    return null;
  }
  return (0, import_jsx_runtime4.jsx)(AccessibleIcon, { label, children });
};
...
var NavUser = ({ children, initials, ...props }) => {
  ...
  return (0, import_jsx_runtime5.jsx)(
    Flex,
    {
      ...
      ...props,
      children: (0, import_jsx_runtime5.jsxs)(Menu.Root, { children: [
        (0, import_jsx_runtime5.jsxs)(MenuTrigger, { endIcon: null, fullWidth: true, justifyContent: "center", children: [
          (0, import_jsx_runtime5.jsx)(Avatar.Item, { delayMs: 0, fallback: initials }),
          (0, import_jsx_runtime5.jsx)(VisuallyHidden, { tag: "span", children })
        ] }),
        (0, import_jsx_runtime5.jsxs)(MenuContent, { popoverPlacement: "top-start", zIndex: 3, children: [
          (0, import_jsx_runtime5.jsxs)(UserInfo, { direction: "column", gap: 0, alignItems: "flex-start", children: [
            (0, import_jsx_runtime5.jsx)(Typography, { variant: "omega", fontWeight: "bold", textTransform: "none", children }),
            (0, import_jsx_runtime5.jsx)(StyledTypography, { variant: "pi", textColor: "neutral600", children: user == null ? void 0 : user.email }),
            (0, import_jsx_runtime5.jsx)(BadgeWrapper, { children: (_a = user == null ? void 0 : user.roles) == null ? void 0 : _a.map((role) => (0, import_jsx_runtime5.jsx)(Badge, { children: role.name }, role.id)) })
          ] }),
          (0, import_jsx_runtime5.jsx)(Menu.Separator, {}),
          (0, import_jsx_runtime5.jsx)(Menu.Item, { onSelect: handleProfile, children: formatMessage({
            id: "global.profile.settings",
            defaultMessage: "Profile settings"
          }) }),
          (0, import_jsx_runtime5.jsx)(Menu.Item, { variant: "danger", onSelect: handleLogout, color: "danger600", children: formatMessage({
...
var CircleProgressBar = ({ percentage }) => {
  ...
  return (0, import_jsx_runtime6.jsxs)("svg", { width: "32", height: "32", viewBox: "0 0 100 100", children: [
    (0, import_jsx_runtime6.jsx)("defs", { children: (0, import_jsx_runtime6.jsxs)("linearGradient", { id: "progressGradient", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
      (0, import_jsx_runtime6.jsx)("stop", { offset: "0%", stopColor: theme.colors.primary600 }),
      (0, import_jsx_runtime6.jsx)("stop", { offset: "100%", stopColor: theme.colors.alternative600 })
    ] }) }),
    (0, import_jsx_runtime6.jsx)("circle", { cx: "50", cy: "50", r: radius, stroke: "#ccc", strokeWidth: "10", fill: "none" }),
    ...
    (0, import_jsx_runtime6.jsx)("svg", { x: "35", y: "25", width: "50", height: "50", viewBox: "0 0 32 32", children: (0, import_jsx_runtime6.jsx)(
      "path",
      {
...
var TrialCountdown = () => {
  ...
  return (0, import_jsx_runtime6.jsx)(Flex, { justifyContent: "center", padding: 3, children: (0, import_jsx_runtime6.jsx)(
    TooltipImpl,
    {
      label: formatMessage(
        isTargetDateInPast ? {
      ...
      side: "right",
      children: (0, import_jsx_runtime6.jsx)("div", { "data-testid": "trial-countdown", children: (0, import_jsx_runtime6.jsx)(CircleProgressBar, { percentage: (30 - daysLeft) * 100 / 30 }) })
    }
  ) });
};
...
var LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  return (0, import_jsx_runtime7.jsxs)(MainNav, { children: [
    (0, import_jsx_runtime7.jsx)(NavBrand, {}),
    (0, import_jsx_runtime7.jsx)(Divider, {}),
    (0, import_jsx_runtime7.jsx)(NavListWrapper, { tag: "ul", gap: 3, direction: "column", flex: 1, paddingTop: 3, paddingBottom: 3, children: listLinks.length > 0 ? listLinks.map((link) => {
      const LinkIcon = link.icon;
      const badgeContentLock = (link == null ? void 0 : link.licenseOnly) ? (0, import_jsx_runtime7.jsx)(ForwardRef$2x, { fill: "primary600" }) : void 0;
      ...
      return (0, import_jsx_runtime7.jsx)(Flex, { tag: "li", children: (0, import_jsx_runtime7.jsx)(NavLink2.Tooltip, { label: labelValue, children: (0, import_jsx_runtime7.jsxs)(
        NavLink2.Link,
        {
          to: link.to,
          ...
          children: [
            (0, import_jsx_runtime7.jsx)(NavLink2.Icon, { label: labelValue, children: (0, import_jsx_runtime7.jsx)(LinkIcon, { width: "20", height: "20", fill: "neutral500" }) }),
            badgeContentLock ? (0, import_jsx_runtime7.jsx)(
              NavLinkBadgeLock,
              {
                label: "locked",
            ...
            ) : badgeContentNumeric ? (0, import_jsx_runtime7.jsx)(
              NavLinkBadgeCounter,
              {
    ...
    (0, import_jsx_runtime7.jsx)(NavUser, { initials, children: userDisplayName })
  ] });
};
...
var PluginsInitializer = ({ children }) => {
  ...
  const [{ plugins }, dispatch] = React2.useReducer(
    reducer,
    initialState,
    () => init(appPlugins)
  );
  ...
  if (hasApluginNotReady) {
    const initializers = Object.keys(plugins).reduce((acc, current) => {
      ...
      if (InitializerComponent) {
        ...
        acc.push((0, import_jsx_runtime8.jsx)(InitializerComponent, { setPlugin: setPlugin.current }, key));
      }
      return acc;
    }, []);
...
var Banner = ({ isTrialEndedRecently }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime9.jsx)(BannerBackground, { width: "100%", justifyContent: "center", children: (0, import_jsx_runtime9.jsxs)(
    Flex,
    {
      justifyContent: "center",
      alignItems: "center",
      ...
      gap: 2,
      children: [
        (0, import_jsx_runtime9.jsxs)(Box, { children: [
        ...
        (0, import_jsx_runtime9.jsx)(Box, { children: (0, import_jsx_runtime9.jsx)(
          LinkButton,
          {
            width: "max-content",
            variant: "tertiary",
...
var UpsellBanner = () => {
  ...
  if (((_b = timeLeftData.data) == null ? void 0 : _b.trialEndsAt) || isTrialEndedRecently) {
    return (0, import_jsx_runtime9.jsx)(Banner, { isTrialEndedRecently });
  }
  return null;
};
  ...
  return (0, import_jsx_runtime10.jsxs)(
    AppInfoProvider,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime10.jsx)(PluginsInitializer, { children: (0, import_jsx_runtime10.jsx)(DndProvider, { backend: HTML5Backend, children: (0, import_jsx_runtime10.jsxs)(Box, { background: "neutral100", children: [
          (0, import_jsx_runtime10.jsx)(SkipToContent, { children: formatMessage({ id: "skipToContent", defaultMessage: "Skip to content" }) }),
          (0, import_jsx_runtime10.jsxs)(Flex, { alignItems: "flex-start", children: [
            ...
            (0, import_jsx_runtime10.jsxs)(Box, { flex: 1, children: [
...
var PrivateAdminLayout = () => {
  return (0, import_jsx_runtime10.jsx)(PrivateRoute, { children: (0, import_jsx_runtime10.jsx)(AdminLayout, {}) });
};
...
//# sourceMappingURL=AuthenticatedLayout-EDZXS2UM.js.map
