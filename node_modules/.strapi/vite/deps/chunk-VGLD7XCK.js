...
import {
  getBasename
} from "./chunk-G3UG26ZE.js";
import {
  useClipboard
} from "./chunk-6Q5DMVVB.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-D5N4CUND.js";
import {
  Login
} from "./chunk-7WFYXSNR.js";
import {
...
import {
  require_pick
} from "./chunk-O4TQZ7PI.js";
import {
  require_defaultsDeep
} from "./chunk-6VYH4IES.js";
import {
  QueryClient,
  QueryClientProvider
...
import {
  require_omit
} from "./chunk-EHBUXG3W.js";
import {
  require_throttle
} from "./chunk-CEKG4MVB.js";
import {
  require_browser
} from "./chunk-CLDKBGB3.js";
import {
  require_merge
} from "./chunk-RYHDJ43U.js";
import {
  require_logic
} from "./chunk-SMSMUSQ2.js";
import {
  z
} from "./chunk-PBKEIS74.js";
import {
  combineReducers,
  configureStore,
  isRejected
...
import Logo2 from "C:/Users/parth/strapi/packages/core/admin/admin/src/assets/images/logo-strapi-2022.svg";
...
var NotFoundPage = () => {
  ...
  return (0, import_jsx_runtime6.jsxs)(Page.Main, { labelledBy: "title", children: [
    ...
    (0, import_jsx_runtime6.jsx)(Layouts.Content, { children: (0, import_jsx_runtime6.jsx)(
      EmptyStateLayout,
      {
        action: (0, import_jsx_runtime6.jsx)(LinkButton, { tag: Link2, variant: "secondary", endIcon: (0, import_jsx_runtime6.jsx)(ForwardRef$5l, {}), to: "/", children: formatMessage({
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-PAV7BE4M.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-EL4HJAUY.js");
        return {
...
var ForgotPassword = () => {
  ...
  return (0, import_jsx_runtime7.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime7.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime7.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime7.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime7.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }) }) }) })
  ] }) });
};
...
var ForgotPasswordSuccess = () => {
  ...
  return (0, import_jsx_runtime8.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime8.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime8.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime8.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime8.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }) }) }) })
  ] }) });
};
...
var Oops = () => {
  ...
  return (0, import_jsx_runtime9.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime9.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime9.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime9.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime9.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }) }) }) })
  ] }) });
};
...
var Register = ({ hasAdmin }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime10.jsxs)(LayoutContent, { children: [
    ...
    (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime10.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime10.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime10.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({
...
var ResetPassword = () => {
  ...
  return (0, import_jsx_runtime11.jsx)(UnauthenticatedLayout, { children: (0, import_jsx_runtime11.jsxs)(Main, { children: [
    ...
    (0, import_jsx_runtime11.jsx)(Flex, { justifyContent: "center", children: (0, import_jsx_runtime11.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime11.jsx)(Link, { tag: NavLink, to: "/auth/login", children: formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }) }) }) })
  ] }) });
};
...
var AuthPage = () => {
  ...
  const Login2 = useEnterprise(
    Login,
    async () => (await import("./Login-NOWUHABJ.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-3R355KMJ.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ID2KE5YW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-PIIRER7Q.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-SOVQIVIL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-KG3CC7JH.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-WORLZCBH.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-U6EHUNC5.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-L5V6KAUL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LXJFF6VM.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-PWKCEGAR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-ZMK634CK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-UCSZDEOC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-GH4AXOPP.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-STEXODCP.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-FGNCAZF4.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-A7YMMUPP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-6RZMVLXG.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-ULGYJ274.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-PZQKOS4S.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-QXMG4FS2.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-4DHQVPSD.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-YDZMRR5K.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-HX2HEEZY.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-Z3DV2RKL.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-YCFLWLMY.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-EDZXS2UM.js");
              return {
...
var Widgets = class {
  constructor() {
    ...
    __publicField(this, "register", (widget) => {
...
var globImport_translations_js = __glob({
  "./translations/en-GB.js": () => import("./en-GB-AWD7ACNJ.js")
});

// import("./translations/**/*.json") in ../packages/core/admin/admin/src/StrapiApp.tsx
var globImport_translations_json = __glob({
  "./translations/ar.json": () => import("./ar-ZPZENJSL.js"),
  "./translations/ca.json": () => import("./ca-6BTJP3D2.js"),
  "./translations/cs.json": () => import("./cs-M5VVNSMW.js"),
  "./translations/de.json": () => import("./de-ZTXMGM2Y.js"),
  "./translations/dk.json": () => import("./dk-TRU2EBXX.js"),
  "./translations/en.json": () => import("./en-VSMSI3PR.js"),
  "./translations/es.json": () => import("./es-HJ3A6M4A.js"),
  "./translations/eu.json": () => import("./eu-KRO4XD7X.js"),
  "./translations/fr.json": () => import("./fr-AL67TEPE.js"),
  "./translations/gu.json": () => import("./gu-AL5QOP6M.js"),
  "./translations/he.json": () => import("./he-J4JGUBPK.js"),
  "./translations/hi.json": () => import("./hi-5X4Y42QG.js"),
  "./translations/hu.json": () => import("./hu-M4U24CQE.js"),
  "./translations/id.json": () => import("./id-D6HJ74N6.js"),
  "./translations/it.json": () => import("./it-U4GKHOBA.js"),
  "./translations/ja.json": () => import("./ja-V2UNHHNI.js"),
  "./translations/ko.json": () => import("./ko-NG5EPG4W.js"),
  "./translations/ml.json": () => import("./ml-SOXCJD55.js"),
  "./translations/ms.json": () => import("./ms-ICAK74JC.js"),
  "./translations/nl.json": () => import("./nl-AYWC3Q4O.js"),
  "./translations/no.json": () => import("./no-L4YPC3X4.js"),
  "./translations/pl.json": () => import("./pl-PPMXXEAN.js"),
  "./translations/pt-BR.json": () => import("./pt-BR-U5G6RW2F.js"),
  "./translations/pt.json": () => import("./pt-BU52XARV.js"),
  "./translations/ru.json": () => import("./ru-V33Q4FAA.js"),
  "./translations/sa.json": () => import("./sa-MOJX5YLE.js"),
  "./translations/sk.json": () => import("./sk-CTPRUIGQ.js"),
  "./translations/sv.json": () => import("./sv-UJC7XLQ6.js"),
  "./translations/th.json": () => import("./th-IVWTG5ME.js"),
  "./translations/tr.json": () => import("./tr-QGG2USV6.js"),
  "./translations/uk.json": () => import("./uk-ENULFER7.js"),
  "./translations/vi.json": () => import("./vi-OBH6NFSM.js"),
  "./translations/zh-Hans.json": () => import("./zh-Hans-UHMHM47T.js"),
  "./translations/zh.json": () => import("./zh-XYTJY7VA.js")
});
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-G3TT2GOR.js");
...
//# sourceMappingURL=chunk-VGLD7XCK.js.map
