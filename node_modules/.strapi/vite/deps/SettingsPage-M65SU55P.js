...
var SubmitButton = () => {
  ...
  return (0, import_jsx_runtime.jsx)(Button, { type: "submit", startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$4N, {}), disabled: isSubmitting || !modified, children: formatMessage({ id: "global.save", defaultMessage: "Save" }) });
};
...
// ../packages/plugins/i18n/admin/src/components/LocaleTable.tsx
var React4 = __toESM(require_react());

// ../packages/plugins/i18n/admin/src/components/DeleteLocale.tsx
...
var DeleteLocale = ({ id, name }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Dialog.Root, { open: visible, onOpenChange: setVisible, children: [
    ...
    (0, import_jsx_runtime2.jsx)(ConfirmDialog, { onConfirm: handleConfirm })
  ] });
};

// ../packages/plugins/i18n/admin/src/components/EditLocale.tsx
...
var EditLocale = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    (0, import_jsx_runtime3.jsx)(EditModal, { ...props, open: visible, onOpenChange: setVisible })
  ] });
};
var EditModal = ({ id, code, isDefault, name, open, onOpenChange }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Modal.Root, { open, onOpenChange, children: (0, import_jsx_runtime3.jsx)(Modal.Content, { children: (0, import_jsx_runtime3.jsxs)(
    Form,
    {
      method: "PUT",
      onSubmit: handleSubmit,
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(Modal.Body, { children: (0, import_jsx_runtime3.jsxs)(Tabs.Root, { variant: "simple", defaultValue: "basic", children: [
          (0, import_jsx_runtime3.jsxs)(Flex, { justifyContent: "space-between", children: [
            (0, import_jsx_runtime3.jsx)(Typography, { tag: "h2", variant: "beta", id: titleId, children: formatMessage({
              id: getTranslation("Settings.locales.modal.title"),
              defaultMessage: "Configuration"
            }) }),
            (0, import_jsx_runtime3.jsxs)(Tabs.List, { "aria-labelledby": titleId, children: [
              (0, import_jsx_runtime3.jsx)(Tabs.Trigger, { value: "basic", children: formatMessage({
                id: getTranslation("Settings.locales.modal.base"),
                defaultMessage: "Basic settings"
              }) }),
              (0, import_jsx_runtime3.jsx)(Tabs.Trigger, { value: "advanced", children: formatMessage({
                id: getTranslation("Settings.locales.modal.advanced"),
                defaultMessage: "Advanced settings"
              }) })
            ] })
          ...
          (0, import_jsx_runtime3.jsxs)(Box, { paddingTop: 7, paddingBottom: 7, children: [
            (0, import_jsx_runtime3.jsx)(Tabs.Content, { value: "basic", children: (0, import_jsx_runtime3.jsx)(BaseForm, { mode: "edit" }) }),
            (0, import_jsx_runtime3.jsx)(Tabs.Content, { value: "advanced", children: (0, import_jsx_runtime3.jsx)(AdvancedForm, { isDefaultLocale: isDefault }) })
          ] })
        ] }) }),
        (0, import_jsx_runtime3.jsxs)(Modal.Footer, { children: [
          (0, import_jsx_runtime3.jsx)(Modal.Close, { children: (0, import_jsx_runtime3.jsx)(Button, { variant: "tertiary", children: formatMessage({ id: "app.components.Button.cancel", defaultMessage: "Cancel" }) }) }),
...
var LocaleTable = ({ locales = [], canDelete, canUpdate }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Table, { colCount: 4, rowCount: locales.length + 1, children: [
    (0, import_jsx_runtime4.jsx)(Thead, { children: (0, import_jsx_runtime4.jsxs)(Tr, { children: [
      (0, import_jsx_runtime4.jsx)(Th, { children: (0, import_jsx_runtime4.jsx)(Typography, { variant: "sigma", textColor: "neutral600", children: formatMessage({
      ...
      (0, import_jsx_runtime4.jsx)(Th, { children: (0, import_jsx_runtime4.jsx)(VisuallyHidden, { children: "Actions" }) })
    ] }) }),
    (0, import_jsx_runtime4.jsx)(Tbody, { children: locales.map((locale) => (0, import_jsx_runtime4.jsxs)(React4.Fragment, { children: [
      (0, import_jsx_runtime4.jsxs)(
        Tr,
        {
          ...
          children: [
            (0, import_jsx_runtime4.jsx)(Td, { children: (0, import_jsx_runtime4.jsx)(Typography, { textColor: "neutral800", children: locale.id }) }),
            (0, import_jsx_runtime4.jsx)(Td, { children: (0, import_jsx_runtime4.jsx)(Typography, { textColor: "neutral800", children: locale.name }) }),
            (0, import_jsx_runtime4.jsx)(Td, { children: (0, import_jsx_runtime4.jsx)(Typography, { textColor: "neutral800", children: locale.isDefault ? formatMessage({
              id: getTranslation("Settings.locales.default"),
              defaultMessage: "Default"
            }) : null }) }),
            (0, import_jsx_runtime4.jsx)(Td, { children: (0, import_jsx_runtime4.jsxs)(Flex, { gap: 1, justifyContent: "flex-end", onClick: (e) => e.stopPropagation(), children: [
              canUpdate && (0, import_jsx_runtime4.jsx)(EditLocale, { ...locale }),
              canDelete && !locale.isDefault && (0, import_jsx_runtime4.jsx)(DeleteLocale, { ...locale })
            ] }) })
          ]
        }
      ),
...
var SettingsPage = () => {
  ...
  return (0, import_jsx_runtime5.jsxs)(Page.Main, { tabIndex: -1, children: [
    (0, import_jsx_runtime5.jsx)(
      Layouts.Header,
      {
        primaryAction: (0, import_jsx_runtime5.jsx)(CreateLocale, { disabled: !canCreate }),
        title: formatMessage({
    ...
    (0, import_jsx_runtime5.jsx)(Layouts.Content, { children: locales.length > 0 ? (0, import_jsx_runtime5.jsx)(LocaleTable, { locales, canDelete, canUpdate }) : (0, import_jsx_runtime5.jsx)(
      EmptyStateLayout,
      {
        icon: (0, import_jsx_runtime5.jsx)(ForwardRef$J, { width: void 0, height: void 0 }),
        content: formatMessage({
          id: getTranslation("Settings.list.empty.title"),
          defaultMessage: "There are no locales"
        }),
        action: (0, import_jsx_runtime5.jsx)(CreateLocale, { disabled: !canCreate, variant: "secondary" })
      }
    ) })
  ] });
};
var ProtectedSettingsPage = () => {
  return (0, import_jsx_runtime5.jsx)(Page.Protect, { permissions: PERMISSIONS.read, children: (0, import_jsx_runtime5.jsx)(SettingsPage, {}) });
};
export {
  ProtectedSettingsPage,
  SettingsPage
};
//# sourceMappingURL=SettingsPage-M65SU55P.js.map
