...
} from "./chunk-JYPVPPYO.js";
import "./chunk-NLQDD6GV.js";
import {
  pluginId
} from "./chunk-KUIKZLKH.js";
...
var globImport_translations_json = __glob({
  "./translations/ar.json": () => import("./ar-IWLJIJTK.js"),
  "./translations/cs.json": () => import("./cs-R2FWROOK.js"),
  "./translations/de.json": () => import("./de-ZTTRRRQA.js"),
  "./translations/dk.json": () => import("./dk-IWECWOCQ.js"),
  "./translations/en.json": () => import("./en-GVWUEVLU.js"),
  "./translations/es.json": () => import("./es-GCTXZI5P.js"),
  "./translations/fr.json": () => import("./fr-3MXRJSSN.js"),
  "./translations/id.json": () => import("./id-5XJMWU7X.js"),
  "./translations/it.json": () => import("./it-7NGJ3UJ5.js"),
  "./translations/ja.json": () => import("./ja-CIJKCHBT.js"),
  "./translations/ko.json": () => import("./ko-2OZSBGMF.js"),
  "./translations/ms.json": () => import("./ms-LBIR64EM.js"),
  "./translations/nl.json": () => import("./nl-3M6BYX37.js"),
  "./translations/pl.json": () => import("./pl-OWQYTDL6.js"),
  "./translations/pt-BR.json": () => import("./pt-BR-UHPK6N7F.js"),
  "./translations/pt.json": () => import("./pt-DBOTM6QU.js"),
  "./translations/ru.json": () => import("./ru-PFHVFZC2.js"),
  "./translations/sk.json": () => import("./sk-4YCPBYEL.js"),
  "./translations/sv.json": () => import("./sv-MC4WEEI5.js"),
  "./translations/th.json": () => import("./th-RCTHLXUB.js"),
  "./translations/tr.json": () => import("./tr-RCVH5L36.js"),
  "./translations/uk.json": () => import("./uk-NH5N6W3P.js"),
  "./translations/zh-Hans.json": () => import("./zh-Hans-SE4BHQ3C.js"),
  "./translations/zh.json": () => import("./zh-CSGZ4PP4.js")
});
...
var src_default2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-ULUH5XHP.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var globImport_translations_json2 = __glob({
  "./translations/ar.json": () => import("./ar-4B4D56T6.js"),
  "./translations/cs.json": () => import("./cs-SCCYMGWY.js"),
  "./translations/de.json": () => import("./de-CIOQ6FHR.js"),
  "./translations/dk.json": () => import("./dk-PVOUK7DT.js"),
  "./translations/en.json": () => import("./en-57KK6JDP.js"),
  "./translations/es.json": () => import("./es-SDUUD4FI.js"),
  "./translations/fr.json": () => import("./fr-LFJYP4XC.js"),
  "./translations/id.json": () => import("./id-U3XCGQPV.js"),
  "./translations/it.json": () => import("./it-M32TZY5G.js"),
  "./translations/ja.json": () => import("./ja-FGR62SHH.js"),
  "./translations/ko.json": () => import("./ko-ANDO77CQ.js"),
  "./translations/ms.json": () => import("./ms-OKA32RFS.js"),
  "./translations/nl.json": () => import("./nl-YNGEGZKS.js"),
  "./translations/pl.json": () => import("./pl-MUA6V3EH.js"),
  "./translations/pt-BR.json": () => import("./pt-BR-BPRZVA5A.js"),
  "./translations/pt.json": () => import("./pt-P4WPJSIH.js"),
  "./translations/ru.json": () => import("./ru-FRSPBFDO.js"),
  "./translations/sk.json": () => import("./sk-AWPPCBM7.js"),
  "./translations/th.json": () => import("./th-O22D6JRP.js"),
  "./translations/tr.json": () => import("./tr-KYTSQNVS.js"),
  "./translations/uk.json": () => import("./uk-6KUWDC2T.js"),
  "./translations/vi.json": () => import("./vi-P5IKQ2N3.js"),
  "./translations/zh-Hans.json": () => import("./zh-Hans-YUZI2NSN.js"),
  "./translations/zh.json": () => import("./zh-AIWQZDTV.js")
});
      ...
      [
        {
          ...
          id: "settings",
          to: "email",
          Component: () => import("./Settings-BLTS3IY2.js").then((mod) => ({
...
var globImport_translations_json3 = __glob({
  "./translations/ca.json": () => import("./ca-PWLFBMRI.js"),
  "./translations/de.json": () => import("./de-XSUJHTH7.js"),
  "./translations/dk.json": () => import("./dk-6I7QFQC6.js"),
  "./translations/en.json": () => import("./en-EEKQJLJQ.js"),
  "./translations/es.json": () => import("./es-M67CDGF3.js"),
  "./translations/fr.json": () => import("./fr-EI57SN4K.js"),
  "./translations/he.json": () => import("./he-X4O4MYXO.js"),
  "./translations/it.json": () => import("./it-K7EPWCGM.js"),
  "./translations/ja.json": () => import("./ja-AGFF6JSD.js"),
  "./translations/ko.json": () => import("./ko-OBMVP2AD.js"),
  "./translations/ms.json": () => import("./ms-7HU4C77Y.js"),
  "./translations/pl.json": () => import("./pl-MJFUVW7P.js"),
  "./translations/pt-BR.json": () => import("./pt-BR-SGPYHHJX.js"),
  "./translations/pt.json": () => import("./pt-P6KY5KGO.js"),
  "./translations/ru.json": () => import("./ru-2I2V66NC.js"),
  "./translations/sk.json": () => import("./sk-JGM6CF5M.js"),
  "./translations/th.json": () => import("./th-UKBV4UJ2.js"),
  "./translations/tr.json": () => import("./tr-FPO36N4X.js"),
  "./translations/uk.json": () => import("./uk-HYAAI2PN.js"),
  "./translations/zh-Hans.json": () => import("./zh-Hans-35N54EZU.js"),
  "./translations/zh.json": () => import("./zh-VRE4QSS4.js")
});
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-OQLXNOY2.js").then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-YKYHPKUK.js");
...
var globImport_translations_json4 = __glob({
  "./translations/de.json": () => import("./de-VCVSEZ64.js"),
  "./translations/dk.json": () => import("./dk-ZDMK7YXL.js"),
  "./translations/en.json": () => import("./en-UCNDAWOX.js"),
  "./translations/es.json": () => import("./es-QT4VFUYY.js"),
  "./translations/fr.json": () => import("./fr-SL3K7KK3.js"),
  "./translations/ko.json": () => import("./ko-GAJGUBQF.js"),
  "./translations/pl.json": () => import("./pl-A7KBGSXM.js"),
  "./translations/ru.json": () => import("./ru-TJJB3RIN.js"),
  "./translations/tr.json": () => import("./tr-TOX2X3QO.js"),
  "./translations/uk.json": () => import("./uk-PP7QCHML.js"),
  "./translations/zh-Hans.json": () => import("./zh-Hans-RUTTPYRR.js"),
  "./translations/zh.json": () => import("./zh-NBDCZJ43.js")
});
...
var src_default5 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-M65SU55P.js").then((mod) => ({ default: mod.ProtectedSettingsPage })),
      ...
      content: ({ onClose }) => {
        return (0, import_jsx_runtime25.jsx)(
          Formik,
          {
            ...
            validationSchema: RELEASE_ACTION_FORM_SCHEMA,
            initialValues: INITIAL_VALUES,
            children: ({ values, setFieldValue }) => (0, import_jsx_runtime25.jsxs)(Form, { children: [
...
var ReleaseListCell = ({ documentId, model }) => {
  ...
  return (0, import_jsx_runtime26.jsxs)(Popover.Root, { children: [
    ...
    (0, import_jsx_runtime26.jsx)(Popover.Content, { children: (0, import_jsx_runtime26.jsx)("ul", { children: releases.map(({ id, name: name2 }) => (0, import_jsx_runtime26.jsx)(Box, { padding: 3, tag: "li", children: (0, import_jsx_runtime26.jsx)(Link, { href: `/admin/plugins/content-releases/${id}`, isExternal: false, children: name2 }) }, id)) }) })
  ] });
};
...
var globImport_translations_json5 = __glob({
  "./translations/en.json": () => import("./en-BOPKG4WV.js"),
  "./translations/uk.json": () => import("./uk-U4O5G6U7.js")
});
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ZCJU5PAC.js").then((mod) => ({ default: mod.App })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-TNYS57YU.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-L7ASQVMY.js");
...
var globImport_translations_json6 = __glob({
  "./translations/en.json": () => import("./en-LJP2W7IS.js"),
  "./translations/uk.json": () => import("./uk-VSP4D7VN.js")
});
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-BS3I65D7.js");
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-SMC6LC3X.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-ADLLYE65.js");
